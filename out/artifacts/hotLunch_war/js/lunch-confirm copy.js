    ...
    $.ajax(
            {
                ...
                success: function (result)
                {
                    ...
                    if (result != null)
                    {
                        ...
                        var lunchMap = result.lunchOrderItemMap.orderItemMap;

                        /**
                         * sort the lunch map according to date -- date is the key, the place is the value/index
                         * @type {Array}
                         */
                        var calendarMap = getCalendarMap(); // <String(date), Integer(order)
                        var orderedDateMap = getOrderedDateMap(); // <Integer, String(date)
                         ...
                         */
                        var buffer = [];
                        buffer.push('<h2>November Hot Lunch Order Confirmation</h2>');
                        ...
                        bottomBuffer.push('<h2>November Hot Lunch Order Confirmation</h2>');
