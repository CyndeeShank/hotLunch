...
public class Util
{
    ...
    public static Iterable<Entity> listEntities(String kind, String searchBy,
                                                String searchFor)
    {
        logger.log(Level.INFO, "Search entities based on search criteria... kind:" + kind + " /searchBy: " + searchBy + " /searchFor: " + searchFor);
     ...
     *
     * @param entities  : List of parent entities
     * @param childKind : Entity type for Child
     * @param fkName    : foreign-key to the parent in the child entity
     * @return JSON string
     */
    ...
    public static String getPrettyChoiceName(String choice, int itemType)
    {
        String value = "";

        switch (itemType)
        {
            case Constants.CARLS_ITEM:
                ...
                break;
            case Constants.CHICKFILA_ITEM:
                if (choice.equals("breaded"))
                {
                    value = "breaded nuggets";
                }
                else if (choice.equals("grilled"))
                {
                    value = "grilled nuggets";
                }
                break;
            case Constants.CHIPOTLE_ITEM:
                if (choice.equals("chicken"))
                {
                    value = "chicken quesadilla";
                }
                else if (choice.equals("cheese"))
                {
                    value = "cheese quesadilla";
                }
                else if (choice.equals("one"))
                {
                    value = "one quesadilla";
                }
                else if (choice.equals("two"))
                {
                    value = "two quesadillas";
                }
                break;
            case Constants.KFC_ITEM:
                if (choice.equals("strips"))
                {
                ...
                break;
            case Constants.PICKUPSTIX_ITEM:
                if (choice.equals("chicken"))
                {
                    value = "chicken bowl";
                }
                else if (choice.equals("tofu"))
                {
                    value = "tofu bowl";
                }
                ...
                else if (choice.equals("brown"))
                {
                    value = "brown rice";
                }
                break;
            case Constants.PIZZA1_ITEM:
            case Constants.PIZZA2_ITEM:
                if (choice.equals("cheese"))
                {
                    value = "cheese pizza";
                }
                else if (choice.equals("pepp"))
                {
                ...
                else if (choice.equals("veggie"))
                {
                    value = "veggie";
                }
                break;
            case Constants.PORTOFINO1_ITEM:
                if (choice.equals("cheese"))
                {
                    value = "cheese sauce";
                }
                ...
                break;
            case Constants.PORTOFINO2_ITEM:
                if (choice.equals("pasta"))
                {
                    value = "pasta w/ marinara & meatball";
                }
                else if (choice.equals("lasagna"))
                {
                    value = "lasagna";
                }
                else if (choice.equals("salad"))
                {
                    value = "salad w/ grilled chicken";
                }
                break;
            case Constants.SMOOTHIE_ITEM:
                if (choice.equals("jetty"))
                {
                ...
                else if (choice.equals("turkey"))
                {
                    value = "turkey croissant";
                }
                else if (choice.equals("ham"))
                {
                    value = "ham croissant";
                }
                break;
            case Constants.SUBWAY_ITEM:
                if (choice.equals("turkey"))
                {
    ...
    public static String getPrettyName(String name)
    {
        ...
        else if (name.equals("FLAMEBROILER"))
        {
            return "Flame Broiler";
        }
        else if (name.equals("HOTDOG"))
        {
        ...
        else if (name.equals("PICKUPSTIX"))
        {
            return "Pick Up Stix";
        }
        else if (name.equals("PIZZA1") || name.equals("PIZZA2"))
        {
            return "Pizza";
        }
        else if (name.equals("PORTOFINO1"))
        {
            return "Portofino Pasta";
        }
        else if (name.equals("PORTOFINO2"))
        {
